...
export default function PrivatumoPolitika() {
  return (
    <main className="container py-10 prose prose-neutral dark:prose-invert max-w-3xl">
      ...
      <h2>5. Duomenų gavėjai ir tvarkytojai</h2>
      <p>
        Jūsų duomenys gali būti perduodami mūsų pasitelktiems paslaugų teikėjams (duomenų tvarkytojams), kiek tai būtina
        paslaugoms teikti ir tik pagal mūsų nurodymus:
      </p>
      <ul>
        <li>
      ...
      <ul>
        ...
        <li>teisė reikalauti ištaisyti netikslius ar papildyti neišsamius duomenis;</li>
        <li>teisė reikalauti ištrinti duomenis („teisė būti pamirštam“), jei taikoma;</li>
        <li>teisė apriboti duomenų tvarkymą;</li>
        <li>teisė į duomenų perkeliamumą;</li>
        <li>teisė nesutikti su tvarkymu, kai jis grindžiamas teisėtu interesu;</li>
      ...
      <ul>
        ...
        <li><strong>Statistiniai/analitiniai</strong> – lankomumo ir našumo matavimui (teisinis pagrindas – sutikimas).</li>
        <li><strong>Rinkodaros</strong> – personalizuotam turiniui/reklamai (teisinis pagrindas – sutikimas).</li>
      </ul>
      <p>
      ...
      <p>
        Politiką galime atnaujinti, pavyzdžiui, pasikeitus teisės aktams ar mūsų paslaugoms. Naujausia versija visada
        skelbiama šioje Svetainėje.
      </p>
